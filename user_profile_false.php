                                    ...
                                    <div class="mdl-card__supporting-text mdl-color-text--grey-600">
                                        ...
                                        <form class="uk-form-horizontal" method="post" action="user_profile_pwd.php">
                                            ...
                                            <div class="uk-margin">
                                                ...
                                                <div class="uk-form-controls uk-form-controls-text">
                                                    <input class="uk-input uk-form-small" id="form-stacked-text" type="password" name="newpwd" placeholder="รหัสผ่านใหม่"> <small style="color:red">คุณใส่รหัสผ่านไม่ตรงกัน กรุณาลองใหม่อีกครั้ง</small> </div>
                                            </div>
                                            <div class="uk-margin">
                                                <label class="uk-form-label">ยืนยันรหัสผ่านใหม่</label>
                                                <div class="uk-form-controls uk-form-controls-text">
                                                    <input class="uk-input uk-form-small" id="form-stacked-text" type="password" name="newpwd2" placeholder="รหัสผ่านใหม่"> <small style="color:red">คุณใส่รหัสผ่านไม่ตรงกัน กรุณาลองใหม่อีกครั้ง</small></div>
                                            </div>
                                            <hr>
                                            ...
                                            <div class="uk-margin">
                                                ...
                                                <div class="uk-form-controls uk-form-controls-text">
                                                    <input class="uk-input uk-form-small" id="answer" name="answer" type="text" placeholder="คำตอบ"> </div>
                                            </div>
