                                    ...
                                    <form class="uk-form-horizontal" method="post" action="admin_add_save.php" enctype="multipart/form-data">
                                        ...
                                        <div class="uk-margin">
                                            ...
                                            <div class="uk-form-controls uk-form-controls-text">
                                                <input class="uk-input uk-form-small uk-width-1-2@m" id="form-stacked-text" type="text" name="user">
                                            </div>
                                        </div>
                                        ...
                                        <div class="uk-margin">
                                            ...
                                            <div class="uk-form-controls uk-form-controls-text">
                                                <input class="uk-input uk-form-small uk-width-1-2@m" id="form-stacked-text" type="text" name="f_user">
                                            </div>
                                        </div>
                                        ...
                                        <div class="uk-margin">
                                            ...
                                            <div class="uk-form-controls uk-form-controls-text">
                                                <input class="uk-input uk-form-small uk-width-1-2@m" id="form-stacked-text" type="text" name="l_user">
                                            </div>
                                        </div>
                                            ...
                                            <div class="uk-form-controls uk-form-controls-text">
                                              <div id="test" style="visibility:hidden">
                                                <div class="uk-margin-bottom">
                                                  ...
                                                  <div id="chief_input" style="visibility:hidden">
                                                    ประจำเดือน :
                                                    <select name="chief_month" class="uk-margin-right">
                                                      <option value="1">มกราคม</option>
                                                      <option value="2">มิถุนายน</option>
                                                      <option value="3">พฤษภาคม</option>
                                                      <option value="4">เมษายน</option>
