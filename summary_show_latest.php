...
$pps = $sumData['pps'];
$gds = $sumData['gds'];
$mini_time = $sumData['mini_time'];
$mini_place = $sumData['mini_place'];
$mini_reg = $sumData['mini_reg'];
$mini_cal = $sumData['mini_cal'];
$mini_recall = $sumData['mini_recall'];
$mini_naming = $sumData['mini_naming'];
$mini_repetition = $sumData['mini_repetition'];
$mini_verbal = $sumData['mini_verbal'];
$mini_written = $sumData['mini_written'];
$mini_writing = $sumData['mini_writing'];
$mini_vis = $sumData['mini_vis'];
